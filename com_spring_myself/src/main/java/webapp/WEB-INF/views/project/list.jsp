...
<body>
    ...
    <div class="wrap">
        ...
        <div class="project-list">
            ...
            <div class="amount">
                <a class="btn btn-danger" href="/project/list?amount=10">10</a>
                <a class="btn btn-danger" href="/project/list?amount=20">20</a>
                <a class="btn btn-danger" href="/project/list?amount=30">30</a>
            </div>            
            ...
            <div class="bottom-section">
                ...
                <div class="btn-write">
                    <a class="btn btn-outline-danger btn-lg" href="/project/write">글쓰기</a>
                </div>
            </div>
    ...
    <script>
        ...
        $table.addEventListener('click', e => {
            ...
            location.href = '/project/content?projectNo=' + bn
