...
public class EmployeeController {
    ...
    // 저장소 역할에게 처리를 위임하기 위해 Repository 를 Composition
    ...
    public String form() {
        ...
        log.info("/emp/form GET 요청 발생!");  //  로그쓸때는 System.out.print() 를 안쓰고 log.info() 를 쓴다.
    ...
    public String register(Employee employee) {
        ...
        return "redirect:/emp/list";  // 요청이 끝난 후 /emp/list 로 재요청
    }
