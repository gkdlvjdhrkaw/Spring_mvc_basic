...
public class BasicV2Controller {
    ...
    // @ResponseBody 를 붙이면 문자열이 그대로 브라우저에게 전달됨
    ...
    /*
        1. 우선 register.jsp 를 열어주는 요청 매서드를 작성하요.
        URL: /user/form 입니다.

        2. 사용자가 form 에 등록한 회원정보를 받아서 처리하는 요청 매서드를 작성하요.
        URL: /user/join 입니다.

        3. 2번 요청이 끝난 후 user-result.jsp 로 이동시키시고 해당 파일에서는 회원의 정보를 출력해주세요
    ...
    public String join(user Us, Model model) {
        System.out.println(Us);
        model.addAttribute("usinfo", Us);
